...
<div id="page" class="site">
	...
	<div class="dotted-header">
		<header id="masthead" class="site-header" role="banner" style="background-image: url('<?php header_image(); ?>'); height:<?php echo get_custom_header()->height; ?>%; background-size: 100% 100%; background-position: center;">
